...
public class LetrerosExportacion
{
    ...
    public LetrerosExportacion(Document doc, PdfDocument pdfdoc, String path, String pathOut) throws IOException, FileNotFoundException, InvalidFormatException
    {
        this.doc = doc;
        this.pdfdoc = pdfdoc;
        this.path = path;
    ...
    private void convertirCarteles(String path) throws FileNotFoundException, IOException, InvalidFormatException
    {
